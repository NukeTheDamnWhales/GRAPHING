...
insert into posts (post_id, title, body, user_id, board_id) values
  ...
  (4, 'Why is it all so broken', 'I noticed my messages, sometimes dont send until I've sent a couple, whats going on there. I have lots of pertinent poignant pickle points to ponder with pals', 1 3),
